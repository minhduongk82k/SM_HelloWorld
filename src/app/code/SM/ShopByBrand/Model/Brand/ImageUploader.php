...
class ImageUploader
{
    ...
    public function __construct(
        ...
        $baseTmpPath = 'shopbybrand/tmp/index',
        $basePath = 'shopbybrand/index',
    ...
    {
        return rtrim($path, '/') . 'ImageUploader.php/' . ltrim($imageName, '/');
    }
    ...
    public function saveFileToTmpDir($fileId)
    {
        ...
        if (isset($result['file'])) {
            try {
                $relativePath = rtrim($baseTmpPath, '/') . 'ImageUploader.php/' . ltrim($result['file'], '/');
