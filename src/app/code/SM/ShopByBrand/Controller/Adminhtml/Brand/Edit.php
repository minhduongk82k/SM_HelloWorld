...
class Edit extends \SM\ShopByBrand\Controller\Adminhtml\Brand
{
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create(\SM\ShopByBrand\Model\Brand::class);
        ...
        $this->_coreRegistry->register('SM_shopbybrand_brand', $model);
